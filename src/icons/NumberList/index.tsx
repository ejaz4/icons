...
const NumberList = (args: any) => {
    return (
		<svg width="16" height="16" viewBox="0 0 16 16" {...args}>
			...
			<path d="M1 3.5L2.5 2.5V5.5"></path>
			<path d="M1 10.5H2.75C2.88807 10.5 3 10.6119 3 10.75V11.75C3 11.8881 2.88807 12 2.75 12H1.25C1.11193 12 1 12.1119 1 12.25V13.25C1 13.3881 1.11193 13.5 1.25 13.5H3"></path>
		</svg>
    )
}
